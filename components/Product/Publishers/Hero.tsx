      ...
      <Container className="relative">
        <section className="max-w-xs lg:max-w-[660px] pt-10 pb-96 md:pb-32 lg:pb-52 w-full z-20 mx-auto md:mx-0">
          ...
          >
            ...
            <span className="text-outline"> digitalize</span> your
            children&rsquo;s
            <br className="hidden lg:block" /> book?
          </Title>

          <CommonText className="mt-2 mb-10 max-w-[543px] text-start">
            We want to partner up with publishers with amazing books! We want to
            develop reading interest talking about nature, teaching social
